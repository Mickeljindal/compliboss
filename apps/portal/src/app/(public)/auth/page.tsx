          ...
          <CardFooter className="pb-10">
            <div className="from-primary/10 via-primary/5 to-primary/5 rounded-sm bg-gradient-to-r p-4">
              <h3 className="text-sm font-medium">
                CompliBoss - AI that handles compliance for you in hours.
              </h3>
              <p className="text-muted-foreground mt-1 text-xs">
                CompliBoss makes SOC 2, ISO 27001, HIPAA and GDPR effortless. Eliminate compliance
