      ...
      <AccordionItem value="device-agent">
        ...
        <AccordionContent>
          <div className="px-4 pb-4 space-y-4">
            <p className="text-sm">
              Installing CompliBoss Device Agent helps you and your security administrator keep your
            ...
            <div className="space-y-4">
              ...
              <ol className="list-decimal space-y-4 pl-5 text-sm">
                ...
                <li>
                  <strong>Install the CompliBoss Device Agent</strong>
                  <p className="mt-1">
                    {isMacOS
              ...
              <Accordion>
                <div className="border rounded-xs">
                  <AccordionItem value="about">
                    <div className="px-4">
                      <AccordionTrigger>
                        <span className="text-base">About CompliBoss Device Monitor</span>
                      </AccordionTrigger>
                    </div>
                    <AccordionContent>
                      <div className="px-4 pb-4 text-muted-foreground space-y-2 text-sm">
                        <p>
                          CompliBoss Device Monitor is a lightweight agent that helps ensure your device
                        ...
                        <p>
                          <strong>Security powered by CompliBoss:</strong> Your organization uses CompliBoss to
