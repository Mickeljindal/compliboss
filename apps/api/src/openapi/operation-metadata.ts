...
const CORE_OPERATION_METADATA: Record<string, PublicOperationMetadata> = {
  ...
  PoliciesController_regeneratePolicy_v1: {
    ...
    description:
      'Regenerate policy content using CompliBoss while keeping the result reviewable before it is published or used as compliance evidence.',
  },
  ...
  KnowledgeBaseController_listDocuments_v1: {
    ...
    description:
      'List uploaded knowledge base documents that CompliBoss can use as approved source material for answers, policies, and reviews.',
  },
  KnowledgeBaseController_uploadDocument_v1: {
    summary: 'Upload knowledge base document',
    description:
      'Upload supporting documentation so CompliBoss can process approved source material for questionnaire answers and policy workflows.',
  },
  ...
  AutomationsController_createAutomation_v1: {
    ...
    description:
      'Create an automated evidence workflow attached to a task so CompliBoss can collect recurring proof from connected systems.',
  },
  ...
  ConnectionsController_createConnection_v1: {
    ...
    description:
      'Create an integration connection so CompliBoss can collect evidence, run checks, or sync data from a connected provider.',
  },
  ...
  DeviceAgentController_registerDevice_v1: {
    ...
    description:
      'Register a CompliBoss Device Agent installation so employee endpoint checks can report into compliance tasks and device inventory.',
  },
  ...
  VendorsController_triggerAssessment_v1: {
    ...
    description:
      'Trigger a vendor risk assessment so CompliBoss can update third-party risk evidence and vendor security review status.',
  },
