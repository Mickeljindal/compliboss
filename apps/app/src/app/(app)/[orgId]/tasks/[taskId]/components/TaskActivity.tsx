    ...
    <div className="relative flex gap-3">
      ...
      <div className="flex-1 min-w-0 pb-6">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {user?.role === 'admin' && (
            <span className="inline-flex items-center rounded-md bg-primary px-1.5 py-0.5 text-[10px] font-medium text-primary-foreground">CompliBoss</span>
          )}
          <Badge
            variant="outline"
    ...
    <div className="flex items-start gap-2.5">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {user?.role === 'admin' && (
            <span className="inline-flex items-center rounded-md bg-primary px-1 py-0 text-[9px] font-medium text-primary-foreground">CompliBoss</span>
          )}
          <Badge
            variant="outline"
