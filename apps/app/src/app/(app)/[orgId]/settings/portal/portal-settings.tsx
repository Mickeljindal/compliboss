  ...
  return (
    <SettingGroup>
      <SettingRow
        ...
        description="Employees will be asked to download and install CompliBoss's device agent on their device."
      >
        <Switch
      ...
      <SettingRow
        ...
        description="Employees will be required to complete CompliBoss's security awareness training videos."
      >
        <Switch
